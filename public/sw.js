const C  // Add paths to your main JS/CSS bundles if they are static and known
  ...
  DEXIE_CDN_URL // Cache DexieAME = "smart-receipt-analyzer-v2"; // Incremented cache version
